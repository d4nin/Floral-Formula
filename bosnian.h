...
void cvijetnaFormula(std::string cvijet)
{
	...
	if (cvijet == "Ostrolist" || cvijet == "ostrolist" || cvijet == "Borago officialis" || cvijet == "borago officialis") {
		...
		std::cout << "3. Graficki prikaz\n";
		SetConsoleTextAttribute(h, 7);
		again8:std::cin >> odluka;
		std::wstring_convert<std::codecvt_utf8_utf16<wchar_t>> convert;
		std::wstring url;
		switch(odluka) {
			case 1:
  				url = convert.from_bytes("https://cdn.discordapp.com/attachments/594198772150698024/1070419460713881720/meadow-daisy-seed-s869_3d4d3380-4b8c-4f35-b730-02060660d800_1024x1024.webp");
  				ShellExecuteW(NULL, L"open", url.c_str(), NULL, NULL, SW_SHOWNORMAL);
				break;
			case 2:
				url = convert.from_bytes("https://cdn.discordapp.com/attachments/594198772150698024/1070419461095555192/UTB8RHJsjFfJXKJkSamH762LyVXaH.png");
				ShellExecuteW(NULL, L"open", url.c_str(), NULL, NULL, SW_SHOWNORMAL);
				break;
			case 3:
				url = convert.from_bytes("https://cdn.discordapp.com/attachments/594198772150698024/1070419461326246009/Capture.PNG");
				ShellExecuteW(NULL, L"open", url.c_str(), NULL, NULL, SW_SHOWNORMAL);
				break;
			default:
				std::cout << "Molimo vas da izabere brojeve izmedju 1-3!\n";
		...
		std::cout << "3. Graficki prikaz\n";
		SetConsoleTextAttribute(h, 7);
		again10:std::cin >> odluka;
		std::wstring_convert<std::codecvt_utf8_utf16<wchar_t>> convert;
		std::wstring url;
		switch(odluka) {
			case 1:
  				url = convert.from_bytes("https://cdn.discordapp.com/attachments/594198772150698024/1070421140016730182/sdf.PNG");
  				ShellExecuteW(NULL, L"open", url.c_str(), NULL, NULL, SW_SHOWNORMAL);
				break;
			case 2:
				url = convert.from_bytes("https://cdn.discordapp.com/attachments/594198772150698024/1070421139492458658/Capture.PNG");
				ShellExecuteW(NULL, L"open", url.c_str(), NULL, NULL, SW_SHOWNORMAL);
				break;
			case 3:
				url = convert.from_bytes("https://cdn.discordapp.com/attachments/594198772150698024/1070421139735707739/fffff.PNG");
				ShellExecuteW(NULL, L"open", url.c_str(), NULL, NULL, SW_SHOWNORMAL);
				break;
			default:
				std::cout << "Molimo vas da izabere brojeve izmedju 1-3!\n";
